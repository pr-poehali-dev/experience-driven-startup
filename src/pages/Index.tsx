...
const CONSULTANT_PHOTO = "https://cdn.poehali.dev/projects/a372cb81-d736-4863-af6b-3d6f18a2ccc7/bucket/53b7cc0b-b544-41da-93ec-3baa8f714800.png";
            ...
            <div className="luxury-card p-10 lg:p-14 mb-12">
              ...
              <div className="flex flex-col">
                <p className="text-cream-muted text-base font-body leading-relaxed mb-6">
                  <span className="font-display text-cream font-semibold text-lg">Alto Livello</span> — «высший уровень» в переводе с итальянского. Бренд создан для российского рынка премиальных продуктов питания. Под этим брендом выпускаются макаронные изделия высшего качества, ориентированные на взыскательного покупателя.
                </p>
